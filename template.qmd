...
Model performance metrics for each cluster and scenario are summarized in @tbl-model_eval. Overall, the ensemble LSTM models demonstrated strong predictive skill across all hydroclimatic clusters and scenarios during the validation period (2014–2024). Clusters 2 and 3 exhibited the best performance, with low MAE and RMSE values and high NSE scores, indicating accurate capture of both magnitude and variability in base flow. Cluster 1 showed moderate skill, with relatively low MAE and RMSE values, though also showing low NSE values. Cluster 4 had the highest errors and a low NSE, reflecting the challenges of modeling base flow in regimes with high variability (e.g. arid and monsoon-influenced regimes). Performance was generally consistent between SSP2-4.5 and SSP5-8.5 scenarios, suggesting that the model is robust to different climate forcings. Residual plots are found in Figure S1 and S2.
...
Projections indicate persistent declines in base flow across western U.S. headwater basins throughout the 21st century, with the magnitude of reductions varying between emission scenarios. Relative to the 1980–2013 baseline, both SSP2-4.5 and SSP5-8.5 exhibit similar early-century (2025–2049) anomalies, followed by continued declines through mid- (2050–2074) and late-century (2075–2099) periods. Trajectories remain comparable through mid-century in both scenarios, but, by late-century, SSP5-8.5 produces substantially larger reductions and greater inter-site variability (@fig-annualized_anomaly a).

Early-century base-flow anomalies are projected to range from –30 to –40 %, corresponding to basin-averaged losses of 3.0–3.4 million AF yr⁻¹. Mid-century reductions deepen to –40 to –50 % (3.6–4.1 million AF yr⁻¹), and by late-century, annual anomalies reach –45 to –65 %, or roughly 3.7–5.8 million AF yr⁻¹, relative to the 1980–2013 baseline (@fig-annualized_anomaly). These patterns indicate that while early-century changes are similar across scenarios, the high-emission SSP5-8.5 pathway drives markedly greater declines in the late-century.
...
Cluster-level projections reveal clear heterogeneity in base-flow responses [@fig-monthly-anomaly_period]. Snowy, responsive Cluster 3 and arid/monsoon-influenced Cluster 4 exhibit the largest relative declines, with median reductions of \~80–90% by late-century under SSP5-8.5 (@fig-monthly-anomaly_period a). Cluster 1, snow-dominated mountainous catchments, showed less declines in the summer and fall. In contrast, mixed-regime Cluster 2 shows more moderate, but variable, relative declines of \~20–70% throughout the year, likely due to its larger size and integrated flow paths buffering against extreme variability. When considering absolute volumetric changes (@fig-monthly-anomaly_period b), Cluster 2 contributes the greatest total loss across all future periods, despite its smaller relative declines. This reflects its' larger base-flow volumes and highlights the importance of considering both relative sensitivity (percent) and hydrologic significance (volume) when assessing climate impacts on streamflow.
