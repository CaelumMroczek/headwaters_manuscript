...
### Importance of baseflow in headwater systems

Headwater catchments provide a disproportionate share of streamflow in the western U.S. Baseflow sustains perennial flow and ecosystems, especially during drought. importance to greater systems, regions of groundwater-surface water interaction

### Sensitivity to climate variability and change

Baseflow responds to changes in precipitation, temperature, and snowpack. Anticipated shifts include altered seasonality and reduced dry-season flow.

### Knowledge gap

Limited understanding of baseflow seasonality and future response across temporal and spatial scales.
...
: Summary of physical, climatic, and base-flow characteristics for each hydroclimatic cluster. Values represent mean conditions for basins within each cluster; base flow statistics are derived from the full 1950–2024 record.
...
: Mixed-effects model coefficients for climate and static predictors of monthly base flow, stratified by hydroclimatic cluster. Coefficients represent fixed-effects on log-transformed base flow; positive values indicate a positive association and negative values indicate a negative association.
...
Across the four hydroclimatic clusters, long-term base-flow trends varied in both magnitude and seasonal timing (Table \_\_ ). Clusters 1, 3, and 4 generally showed small to moderate changes, with a mix of positive and negative trends. In contrast, Cluster 2 exhibited large, widespread negative trends across nearly all months, with median annual declines exceeding 50% per decade. These pronounced decreases may reflect reduced snowpack and a shift in precipitation phase from snow to rain, increasing the frequency of rain-on-snow events and accelerating seasonal runoff (CITE - Musselman et al. 2018)).
...
: Median monthly base-flow trends by hydroclimatic cluster for 1950–2024, expressed as percent change per decade from Theil–Sen slope estimates. Positive values indicate increasing base flow; negative values indicate decreasing base flow. “Pct. Sig. Up” and “Pct. Sig. Down” show the percentage of sites with statistically significant (p \< 0.05) positive or negative trends.
