...
![Monthly distribution of baseflow and precipitation as a percentage of the annual total, stratified by hydroclimatic cluster. Baseflow boxes are colored by cluster (Cluster 1: green, Cluster 2: red, Cluster 3: yellow, Cluster 4: blue), precipitation is shown in gray.](figs/cluster-bf_precip_contrib_legends.png){#fig-bf-precip-contrib}
...
| Cluster | Jan | Feb | Mar | Apr | May | Jun | Jul | Aug | Sep | Oct | Nov | Dec | Median Annual Trend | \% Sig. Up | \% Sig. Down |
|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|
| **1** | 1.22 | 0.38 | 5.60 | 3.92 | 0.50 | -1.31 | -1.71 | 0.08 | -3.22 | -0.64 | 3.14 | 1.10 | 0.44 | 20.7 | 16.4 |
| **2** | -0.39 | -3.75 | -0.24 | -1.28 | -1.63 | -3.54 | -3.71 | -2.79 | -3.04 | -2.59 | -1.10 | -2.31 | -2.45 | 1.47 | 30.4 |
| **3** | -0.61 | -0.95 | 1.12 | 1.12 | 0.04 | -2.33 | -3.10 | -3.26 | -2.25 | -0.92 | -0.77 | -1.81 | -0.94 | 8.6 | 17.4 |
| **4** | -0.13 | -4.27 | 0.32 | 0.00 | -0.11 | -0.37 | -1.92 | -2.75 | -3.54 | -3.28 | -0.88 | -2.35 | -1.40 | 12.8 | 18.8 |
